...
export function ConfirmDeleteModal({ project, onClose, onConfirm }: ConfirmDeleteModalProps) {
  ...
  return (
    <ModalShell id="confirm-delete-title" title="Delete Project" onClose={onClose}>
      <div className="flex flex-col gap-6">
        <div className="flex items-center gap-4 p-4 rounded-xl bg-red-500/10 border border-red-500/20">
          ...
          <p className="text-sm text-muted-foreground leading-relaxed">
            ...
            This will remove the project from all client and vendor dashboards.
            <br/><br/>
        ...
        <div className="flex gap-3">
          ...
          >
            {isLoading ? <Loader2 className="animate-spin" size={16} /> : "Yes, Delete Project"}
          </button>
        </div>
      </div>
    </ModalShell>
